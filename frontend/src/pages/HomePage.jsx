    ...
    const projects = [
        {
            ...
            members: ["Isabelle", "Nicolas", "Clément", "Virginie", "Batiste", "Julie"]
        },
        {
        ...
        <div className="overflow-hidden w-screen">
            ...
            <div className="bg-bleuElectrique h-[92vh] sm:h-screen lg:h-[70vw] xl:h-screen">
                <div className="w-full md:w-3/4 py-14 flex items-center gap-5 flex-col px-3 sm:px-0">
                    <h1 className="w-full sm:w-4/6 xl:w-4/6 font-Gelasio text-5xl sm:text-6xl lg:text-7xl xl:text-8xl text-white">Collaborative data PROJECT</h1>
                    <p className="w-full sm:w-4/6 xl:w-4/6 font-Gelasio text-lg xl:text-xl text-white">Make the companies’daily easier</p>
                    <div className="w-full sm:w-4/6 xl:w-4/6 flex justify-start gap-8 flex-wrap">
                        <Button variant="primary" text="Registration" link="/login" />
                        <Button variant="secondary" text="Connexion" link="/registrer"/>
                    </div>
                </div>
